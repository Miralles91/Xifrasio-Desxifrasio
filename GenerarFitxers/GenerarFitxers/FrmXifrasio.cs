...
namespace GenerarFitxers
{
    public partial class FrmXifrasio : Form
    {
        ...
        {
            String rutaFi = "C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\PACS" + numeroFitxer+".txt";
        ...
        private void crearFitxers() {
            ...
            concatArxius("C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\PACS.txt");
        }
        ...
        private void XifrarLLetraNum(string [] crearLletres, int z)
        {
            ...
            bool verifica;
            string rutaFitxer = "C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\Arxiu" + z+".txt";
        ...
        {
            string A1 = File.ReadAllText("C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\PACS1.txt");
            string A2 = File.ReadAllText("C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\PACS2.txt");
            string A3 = File.ReadAllText("C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\PACS3.txt");
            string A4 = File.ReadAllText("C:\\Users\\admin\\source\\repos\\GenerarFitxers\\Fitxers\\PACS4.txt");
